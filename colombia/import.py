...
if __name__ == "__main__":
        ...
        with app.app_context():
            ...
            dy_p = dy_p[(2004 <= dy_p.year) & (dy_p.year <= 2014)]
            dy_i = dy_i[(2004 <= dy_i.year) & (dy_i.year <= 2014)]
            gdp_df = gdp_df[(2004 <= gdp_df.year) & (gdp_df.year <= 2014)]
            pop_df = pop_df[(2004 <= pop_df.year) & (pop_df.year <= 2014)]
